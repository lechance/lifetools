...
const plateData = {
  ...
  '鲁': ['济南A', '青岛B', '淄博C', '枣庄D', '东营E', '烟台F', '潍坊G', '济宁H', '泰安J', '威海K', '日照L', '莱芜S', '临沂R', '德州N', '聊城P', '滨州M', '菏泽R'],
  ...
  '云': ['昆明A', '曲靖D', '玉溪F', '昭通C', '保山M', '丽江P', '普洱J', '临沧L', '文山H', '红河G', '大理L', '楚雄E', '迪庆R', '怒江Q', '西双版纳K'],
  ...
  '新': ['乌鲁木齐A', '克拉玛依B', '吐鲁番K', '哈密L', '昌吉B', '博尔塔拉E', '巴音郭楞M', '阿克苏N', '克孜勒苏P', '喀什Q', '和田R', '伊犁F', '塔城G', '阿勒泰H'],
  '港': ['香港'],
  '澳': ['澳门'],
}
